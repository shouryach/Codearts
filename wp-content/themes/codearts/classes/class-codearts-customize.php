...
if ( ! class_exists( 'codearts_Customize' ) ) {
	/**
	 * Customizer Settings.
	 *
	 * 
	 */
	class codearts_Customize {
		...
		public function register( $wp_customize ) {
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'Display Site Title & Tagline', 'codearts' ),
				)
			);
			...
			$wp_customize->add_section(
				'excerpt_settings',
				array(
					'title'    => esc_html__( 'Excerpt Settings', 'codearts' ),
					'priority' => 120,
				)
			);
			...
			$wp_customize->add_control(
				...
				array(
					...
					'label'   => esc_html__( 'On Archive Pages, posts show:', 'codearts' ),
					'choices' => array(
						'excerpt' => esc_html__( 'Summary', 'codearts' ),
						'full'    => esc_html__( 'Full text', 'codearts' ),
					),
				)
			);
			...
			include_once get_theme_file_path( 'classes/class-codearts-customize-color-control.php' ); // phpcs:ignore WPThemeReview.CoreFunctionality.FileInclude.FileIncludeFound

			// Register the custom control.
			$wp_customize->register_control_type( 'codearts_Customize_Color_Control' );
			...
			$wp_customize->add_control(
				new codearts_Customize_Color_Control(
					$wp_customize,
					'background_color',
					array(
						'label'   => esc_html_x( 'Background color', 'Customizer control', 'codearts' ),
						'section' => 'colors',
						'palette' => $colors,
					)
				)
